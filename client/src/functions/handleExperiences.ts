...
export const publish = async (id: string | undefined, experiences: IExperienceId[]) => {
  if (!id) return;
...
export const remove = async (id: string | undefined, experience: IExperienceId, experiences: IExperienceId[]) => {
...
export const newUnreviewedArr = (id: string, action: string, unreviewedExperiences: IExperienceId[], experiences: IExperienceId[]) => {
