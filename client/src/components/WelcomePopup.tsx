...
export default function WelcomePopup() {
  ...
  return (
    <section
      className="welcome"
      style={{ display: isVisited ? "none" : "block" }}
    >
      <div
      ...
      >
        ...
        <div className="row direction-row">
          <img
            src={adventurer}
            alt="En man med ryggsäck på toppen av ett berg"
          />
          <div className="cont">
            <div className="text-content">
              ...
              <p>
                ...
                ascot gochujang cloud scenester vibecession praxis yuccie.
                Ethical franzen sustainable snackwave charcoal celiac skateboard
                braid tbh taiyaki. Cray mug photo bag scenester big bottle
                coloring mlkshk xoxo. Woke blue vice craft marfa salvia.
                Pitchfork mood biodiesel mi vegan distillery +1 tumeric raw.
                Vaporware shabby sold thundercats tilde book squid synth
                probably heard.
              </p>
